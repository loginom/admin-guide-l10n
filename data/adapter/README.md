...
В аналитической платформе Loginom имеются [компоненты интеграции с веб-сервисами](https://help.loginom.ru/userguide/integration/web-services/) c использованием протоколов SOAP и REST, которые реализуют наиболее распространенные варианты взаимодействия с веб-сервисами. Но некоторые веб-сервисы могут использовать индивидуальные протоколы и шифрование сообщений, при которых подключиться к ним стандартными средствами Loginom не возможно. Для решения этой задачи предназначен Loginom Adapter (далее, *адаптер*).
