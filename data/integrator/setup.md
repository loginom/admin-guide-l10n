...
>* Веб сервер (Установлено 11 из 43) 
>    + Безопасность (Установлено 1 из 9)
>        - Фильтрация запросов
>    + Исправность и диагностика (Установлено 1 из 6)
>        - Ведение журнала HTTP
>    + Общие функции HTTP (Установлено 4 из 6)
>        - Документ по умолчанию 
>        - Обзор Каталога
>        - Ошибки HTTP
>        - Статическое содержимое
>    + Производительность (Установлено 1 из 2) 
>        - Сжатие статического содержимого
>    + Разработка приложений (Установлено 4 из 11)
>        - ASP.NET 4.6 
>        - Расширения ISAPI
>        - Расширяемость .NET4.6
>        - Фильтры ISAPI
