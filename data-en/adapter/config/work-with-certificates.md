...
- the path in the file system specified in the *Certificate path* parameter. It is recommended to use such a method for the certificates that do not contain the private key.
